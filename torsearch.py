...
#   print(type(x[1]))
	...
	# id	keyword	link	html_text_data  
...
#     cursor.execute("SELECT data FROM darkweblink WHERE id=%s", [1])
#     row = cursor.fetchone()

#     print(row)

# url = "http://hacksinztslhgdka6vrm3vu2cf23unirxuqbtktp7raotphdmq3zkwid.onion"
# torSearcher(url)
